...
<html>
    ...
    <body>
        ...
        <div class="w3-row-padding w3-padding-64 w3-container">
          <div class="w3-content">
            <div class="w3-twothird">
              <h1>Học qua những bài trắc nghiệm ngắn, được biên soạn theo giáo trình
                ôn thi THPT quốc gia</h1>
        ...
        <div class="w3-row-padding w3-padding-64 w3-container">
          <div class="w3-content">
            <div class="w3-twothird">
              <h1>Đánh giá đúng trình độ, bảng xếp hạng được cập nhật từng giây</h1>
                <img src="images/nobrainer.jpg" alt=""/>
            </div>
