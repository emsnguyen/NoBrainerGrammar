...
<div class="tbg">
  ...
  <div class="tbgwrap">
    ...
    <div class="tcontrols">
        <div class="tno">
                <i class="fa fa-times" aria-hidden="true" onclick="window.location.href='ignore';"></i>
        </div>
        <div class="ti"><i class="fa fa-info" aria-hidden="true"></i></div>
        <div class="tyes"><i class="fa fa-heart" aria-hidden="true" onclick="window.location.href='like';"></i></div>
